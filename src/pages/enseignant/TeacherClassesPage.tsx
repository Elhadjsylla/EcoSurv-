...
export const TeacherClassesPage: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6 animate-stagger-rise">
      {/* Top Header */}
        ...
        {CURRENT_ENSEIGNANT.classes_assignees.map((cls) => {
          ...
          return (
            <Card
              ...
              className={`p-5 cursor-pointer transition-all hover:border-emerald-400 ${
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-extrabold text-slate-900 mt-1">Classe de {cls}</h3>
                </div>
                <span className="rounded-lg bg-emerald-100 text-emerald-800 px-2.5 py-1 text-xs font-bold border border-emerald-200">
          ...
          <Card className="p-4 space-y-4">
            ...
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full h-10 pl-9 pr-4 rounded-lg border border-slate-300 bg-white text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition-all"
              />
            </div>
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="border-b border-slate-200 bg-slate-50/80 font-bold uppercase tracking-wider text-slate-500">
                      ...
                      <th className="py-3 px-4 text-right">Moyenne</th>
                    </tr>
                  </thead>
