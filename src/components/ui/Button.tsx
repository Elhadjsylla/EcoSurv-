...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary:
      'bg-slate-100 text-slate-800 hover:bg-slate-200 active:bg-slate-300 border border-slate-200/60 shadow-2xs',
    outline:
    ...
    ghost:
      'text-slate-700 hover:bg-slate-100 hover:text-slate-900 active:bg-slate-200 shadow-none',
    danger:
