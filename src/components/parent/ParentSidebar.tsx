...
export const ParentSidebar: React.FC<ParentSidebarProps> = ({
  ...
  return (
    ...
    >
      {/* Brand Header (Minimalist Nexoov style with Purple badge) */}
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {!isCollapsed && (
            <div className="min-w-0 flex flex-col">
              ...
              <span className="text-[10px] font-bold text-purple-600 dark:text-purple-400 mt-1 uppercase tracking-wider">
                Espace Famille
              </span>
            </div>
          )}
